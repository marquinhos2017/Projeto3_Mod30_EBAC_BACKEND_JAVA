...
import br.dao.factory.ProdutoQuantidadeFactory;
import br.dao.factory.VendaFactory;
import br.dao.generic.GenericDAO;
import br.domain.ProdutoQuantidade;
...
//		return venda;
    ...
    private StringBuilder sqlBaseSelect() {
        ...
        sb.append("C.ID AS ID_CLIENTE, C.NOME, C.CPF, C.TEL, C.ENDERECO, C.NUMERO, C.CIDADE, C.ESTADO, C.IDADE ");  // Add IDADE here if needed
